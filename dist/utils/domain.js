...
exports.isEmailDomainMatching = isEmailDomainMatching;
exports.isValidDomain = isValidDomain;
exports.doDomainsBelongToSameOrg = doDomainsBelongToSameOrg;
/**
 ...
 */
function isEmailDomainMatching(email, companyDomain) {
    try {
 ...
 */
function doDomainsBelongToSameOrg(domain1, domain2) {
    try {
