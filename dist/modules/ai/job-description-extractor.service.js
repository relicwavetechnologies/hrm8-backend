...
exports.jobDescriptionExtractorService = exports.JobDescriptionExtractorService = void 0;
const service_1 = require("../../core/service");
const config_service_1 = require("../system/config.service");
const openai_1 = __importDefault(require("openai"));
class JobDescriptionExtractorService extends service_1.BaseService {
    /**
     * Extract job data using pattern matching (fallback when AI is not available)
     */
    async extractWithPatternMatching(text) {
...
exports.JobDescriptionExtractorService = JobDescriptionExtractorService;
exports.jobDescriptionExtractorService = new JobDescriptionExtractorService();
