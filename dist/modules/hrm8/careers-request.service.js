...
exports.CareersRequestService = void 0;
const service_1 = require("../../core/service");
const http_exception_1 = require("../../core/http-exception");
class CareersRequestService extends service_1.BaseService {
    constructor(careersRequestRepository) {
        super();
        this.careersRequestRepository = careersRequestRepository;
    }
    async getRequests() {
        ...
        const requests = companies.map(company => {
            const pendingChanges = company.careers_pending_changes || {};
            return {
    ...
    async approve(id, section) {
        ...
        if (pendingChanges.logoUrl)
            updateData.careers_page_logo = pendingChanges.logoUrl;
        if (pendingChanges.bannerUrl)
            updateData.careers_page_banner = pendingChanges.bannerUrl;
        if (pendingChanges.about)
            updateData.careers_page_about = pendingChanges.about;
        if (pendingChanges.social)
            updateData.careers_page_social = pendingChanges.social;
...
exports.CareersRequestService = CareersRequestService;
