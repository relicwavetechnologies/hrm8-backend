...
exports.TOOL_REGISTRY = [
    ...
    },
    {
        ...
        description: 'Get complete candidate assessment drawer context for one application: AI analysis, resume, notes, annotations, interviews/meetings, email threads/logs, tasks, and activity.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerContextSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerContext,
    },
    {
        ...
        parameters: assistant_tool_implementations_1.getCandidateDrawerOverviewSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerOverview,
    },
    {
        ...
        parameters: assistant_tool_implementations_1.getCandidateDrawerResumeSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerResume,
    },
    {
        name: 'get_candidate_drawer_ai_review',
        description: 'Get AI review/analysis data shown in candidate drawer AI section.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerAiReviewSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerAiReview,
    },
    {
        name: 'get_candidate_drawer_notes',
        description: 'Get notes section data for candidate drawer.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerNotesSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerNotes,
    },
    {
        ...
        parameters: assistant_tool_implementations_1.getCandidateDrawerQuestionnaireSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerQuestionnaire,
    },
    {
        name: 'get_candidate_drawer_annotations',
        description: 'Get resume annotations for candidate drawer annotation section.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerAnnotationsSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerAnnotations,
    },
    {
        ...
        parameters: assistant_tool_implementations_1.getCandidateDrawerMeetingsSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerMeetings,
    },
    {
        name: 'get_candidate_drawer_emails',
        description: 'Get email threads and email logs for candidate drawer email section.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerEmailsSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerEmails,
    },
    {
        name: 'get_candidate_drawer_tasks',
        description: 'Get tasks and task notes for candidate drawer task section.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerTasksSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerTasks,
    },
    {
        name: 'get_candidate_drawer_activity',
        description: 'Get activity timeline for candidate drawer activity section.',
        parameters: assistant_tool_implementations_1.getCandidateDrawerActivitySchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.getCandidateDrawerActivity,
    },
    {
        name: 'update_candidate_stage',
        description: 'Move a candidate application to a new stage. Requires applicationId and target stage. This is a write action.',
        parameters: assistant_tool_implementations_1.updateCandidateStageSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.updateCandidateStage,
    },
    {
        name: 'add_candidate_note',
        description: 'Add a structured note to candidate application notes (supports note type and mentions). This is a write action.',
        parameters: assistant_tool_implementations_1.addCandidateNoteSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.addCandidateNote,
    },
    {
        name: 'schedule_candidate_interview',
        description: 'Schedule an interview for a candidate application with date, type, duration, optional interviewers, notes, and optional Meet link.',
        parameters: assistant_tool_implementations_1.scheduleCandidateInterviewSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.scheduleCandidateInterview,
    },
    {
        name: 'add_interview_note',
        description: 'Add a note to an existing interview by interviewId. This is a write action and logs activity.',
        parameters: assistant_tool_implementations_1.addInterviewNoteSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.addInterviewNote,
    },
    {
        name: 'send_candidate_email',
        description: 'Send an email to the candidate tied to this application and log it to communication history.',
        parameters: assistant_tool_implementations_1.sendCandidateEmailToolSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.sendCandidateEmailTool,
    },
    {
        name: 'create_candidate_task',
        description: 'Create a new task for this candidate application (title, assignee, status, priority, due date, description).',
        parameters: assistant_tool_implementations_1.createCandidateTaskToolSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.createCandidateTaskTool,
    },
    {
        name: 'add_task_note',
        description: 'Add a note to a specific task within this candidate application context.',
        parameters: assistant_tool_implementations_1.addTaskNoteToolSchema,
        allowedRoles: [assistant_types_1.ToolAccessLevel.COMPANY_ADMIN, assistant_types_1.ToolAccessLevel.COMPANY_USER],
        requiresCompanyScope: true,
        dataSensitivity: 'HIGH',
        run: assistant_tool_implementations_1.addTaskNoteTool,
    },
