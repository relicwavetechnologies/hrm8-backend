...
exports.SalaryBandService = void 0;
...
class SalaryBandService {
     ...
     */
    static async getExecutiveSearchBand(companyId, salaryAmount) {
        ...
        const execTiers = await prisma_1.prisma.priceTier.findMany({
            where: {
        ...
        if (execTiers.length === 0) {
            throw new http_exception_1.HttpException(404, 'No executive search bands configured');
        }
        // Find matching band
     ...
     */
    static async getAllExecutiveSearchBands(companyId) {
        const priceBook = await price_book_selection_service_1.PriceBookSelectionService.getEffectivePriceBook(companyId);
        const execTiers = await prisma_1.prisma.priceTier.findMany({
            where: {
                price_book_id: priceBook.id,
     ...
     */
    static async determineJobBand(companyId, salaryMax) {
...
exports.SalaryBandService = SalaryBandService;
