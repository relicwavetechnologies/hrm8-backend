...
class AssessmentRepository extends repository_1.BaseRepository {
    async create(data) {
    ...
    async findWithCandidateDetails(id) {
        return this.prisma.assessment.findUnique({
            where: { id },
            include: {
                application: {
    ...
    async findByApplicationAndRound(applicationId, jobRoundId) {
    ...
    async findJobRoundWithEmailConfig(jobRoundId) {
        return this.prisma.jobRound.findUnique({
            where: { id: jobRoundId },
            select: { email_config: true }
        });
    }
    async findByRoundIdWithDetails(roundId) {
    ...
    async findByApplicationIdWithDetails(applicationId) {
        return this.prisma.assessment.findMany({
    ...
    async createManyQuestions(data) {
    ...
    async upsertResponse(assessmentId, questionId, candidateId, response) {
    ...
    async findConfigByJobRoundId(jobRoundId) {
        return this.prisma.assessmentConfiguration.findUnique({
            where: { job_round_id: jobRoundId }
        });
    }
    async findApplicationForAssignment(applicationId) {
    ...
    async linkToRoundProgress(applicationId, jobRoundId, assessmentId) {
    ...
    // Grading
    async getGradingData(assessmentId) {
        return this.prisma.assessment.findUnique({
    ...
    async upsertAssessmentVote(assessmentId, userId, vote, comment) {
    ...
    async upsertGrade(responseId, graderId, score, feedback) {
    ...
    async addComment(assessmentId, userId, comment) {
    ...
    async updateAssessmentFeedback(id, feedback) {
    ...
    async completeRoundProgress(applicationId, roundId) {
    ...
    async moveToNextRound(applicationId, currentRoundId) {
        ...
        if (!nextRound)
            return; // No next round (end of pipeline)
