...
class CandidateRepository extends repository_1.BaseRepository {
    ...
    async getAssessmentById(id, candidateId) {
    ...
    async getAssessmentConfig(jobRoundId) {
        return this.prisma.assessmentConfiguration.findUnique({
            where: { job_round_id: jobRoundId }
        });
    }
    async updateAssessmentStatus(id, status, startedAt) {
        const currentResults = (await this.prisma.assessment.findUnique({ where: { id } }))?.results || {};
    ...
    async getJobRoundWithJob(jobRoundId) {
    ...
    async submitAssessmentResponses(assessmentId, candidateId, answers) {
    ...
    async updateResume(resumeId, candidateId, data) {
    ...
    async createResume(candidateId, data) {
    ...
    async updateResumeUrl(candidateId, url) {
        return this.prisma.candidate.update({
            where: { id: candidateId },
            data: { resume_url: url },
        });
    }
    async updateCoverLetter(coverId, data) {
    ...
    async createCoverLetter(candidateId, data) {
    ...
    async deleteCoverLetter(coverId) {
    ...
    async createPortfolio(candidateId, data) {
    ...
    async updateWorkExperience(experienceId, data) {
    ...
    async upsertNotificationPreferences(candidateId, data) {
    ...
    async createSkill(candidateId, data) {
    ...
    async deleteSavedJob(candidateId, jobId) {
