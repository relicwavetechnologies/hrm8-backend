...
exports.ScreeningTemplateController = void 0;
const prisma_1 = require("../../utils/prisma");
const controller_1 = require("../../core/controller");
class ScreeningTemplateController extends controller_1.BaseController {
    constructor() {
        ...
        this.list = async (req, res) => {
            try {
                ...
                const templates = await prisma_1.prisma.screening_templates.findMany({
                    where: {
        ...
        this.create = async (req, res) => {
            try {
                ...
                const template = await prisma_1.prisma.screening_templates.create({
                    data: {
                        id,
                        name: name.trim(),
        ...
        this.getById = async (req, res) => {
            try {
                const { id } = req.params;
                const companyId = req.user?.companyId;
                const template = await prisma_1.prisma.screening_templates.findUnique({
                    where: { id },
                });
                if (!template) {
...
exports.ScreeningTemplateController = ScreeningTemplateController;
