...
import { QuestionGenerationService, ScreeningQuestionOutput } from './question-generation.service';
import { AuthenticatedRequest } from '../../types';

export class ScreeningQuestionsAIController {
  static async generate(req: Request, res: Response) {
    try {
      ...
      const questions: ScreeningQuestionOutput[] = await QuestionGenerationService.generateScreeningQuestions({
