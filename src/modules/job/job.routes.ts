...
router.post('/:id/payg-checkout', authenticate, jobController.initiatePaygJobCheckout);
router.post('/:id/jobtarget/session', authenticate, jobController.createJobTargetSession);
