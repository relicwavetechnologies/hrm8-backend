...
export class JobRoundController extends BaseController {
    ...
    getJobRounds = async (req: AuthenticatedRequest, res: Response) => {
        try {
            ...
            const rounds = await this.service.getJobRounds(jobId, req.user!.companyId as string);
    ...
    getRound = async (req: AuthenticatedRequest, res: Response) => {
        try {
            ...
            const round = await this.service.getRound(id, req.user!.companyId as string);
    ...
    createRound = async (req: AuthenticatedRequest, res: Response) => {
        try {
            ...
            const round = await this.service.createRound(data, { companyId: req.user!.companyId as string });
    ...
    updateRound = async (req: AuthenticatedRequest, res: Response) => {
        try {
            ...
            const round = await this.service.updateRound(id, data, req.user!.companyId as string);
    ...
    deleteRound = async (req: AuthenticatedRequest, res: Response) => {
        try {
            ...
            await this.service.deleteRound(id, req.user!.companyId as string);
