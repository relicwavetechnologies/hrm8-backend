...
export class EmployeeController extends BaseController {
  ...
  getCompanyUsers = async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      const users = await this.employeeService.getCompanyUsers(req.user.companyId);
  ...
  getInvitations = async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      const invitations = await this.employeeService.getPendingInvitations(req.user.companyId);
